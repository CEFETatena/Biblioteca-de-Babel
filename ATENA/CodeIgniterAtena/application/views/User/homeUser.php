                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="modal-body">
                                ...
                                <img class="img-fluid img-centered" src="assets/img/portfolio/vidassecas.jpg" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="modal-body">
                                ...
                                <hr class="star-primary">
                                <img class="img-fluid img-centered" src="img/portfolio/guerradostronos.jpg" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="modal-body">
                                ...
                                <hr class="star-primary">
                                <img class="img-fluid img-centered" src="img/portfolio/furiadosreis.jpg" alt="">
                                <p>Livro muito bom, uma bela obra de George R R Martin</p>
                                <ul class="list-inline item-details">
                                    <li>Usuário:
                                        <strong><p>VictorCabral029</p>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="modal-body">
                                ...
                                <hr class="star-primary">
                                <img class="img-fluid img-centered" src="assets/img/portfolio/tormentadasespadas.jpg" alt="">
                                <p>Livro muito bom, uma bela obra de George R R Martin</p>
                                <ul class="list-inline item-details">
                                    <li>Usuário:
                                        <strong><p>VictorCabral029</p>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="modal-body">
                                ...
                                <hr class="star-primary">
                                <img class="img-fluid img-centered" src="img/portfolio/dancadosdragoes.jpg" alt="">
                                <p>Livro muito bom, uma bela obra de George R R Martin</p>
                                <ul class="list-inline item-details">
                                    <li>Usuário:
                                        <strong><p>VictorCabral029</p>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="modal-body">
                                ...
                                <hr class="star-primary">
                                <img class="img-fluid img-centered" src="img/portfolio/ofestimdoscorvos.jpg" alt="">
                                <p>Livro muito bom, uma bela obra de George R R Martin</p>
                                <ul class="list-inline item-details">
                                    <li>Usuário:
                                        <strong><p>VictorCabral029</p>
