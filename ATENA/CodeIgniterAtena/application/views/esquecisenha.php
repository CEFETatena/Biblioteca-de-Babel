      ...
      <div class="container">
        ...
        <div class="row">
            ...
            working you may need to configure your web server differently. -->
				<form name="recsenha" id="recuperar_senha"  method="POST" action="../Login/esqueci_senha" enctype="multipart/form-data">

              <div class="row control-group">
                <div class="form-group col-xs-4 floating-label-form-group controls">
                  <label>E-mail</label>
                  <input type="emailUsuario" class="form-control" placeholder="E-mail para recuperação de senha" id="txtEmail" name="txtEmail" required="" data-validation-required-message="Insira email valido">
