							...
							echo "<table>" .
										...
										foreach($livros as $livro){
											echo  "<tr>" .
				   		 								...
				   		 								"<td>Descrição: <div class='livroDescricao'>" . $livro->descricao ."</div></td>" .
				   		 								"<td>" . anchor(base_url("livrosAdm/corrigir/" . $livro->idLivro),"Editar", array("class"=>"btn btn-mediun btn-warning")) . "<hr>" .
