...
<body class="index" id="page-top">
        ...
        <div class="container">
           ...
           <div class="collapse navbar-collapse" id="navbarExample">
                <ul class="navbar-nav ml-auto">
                   <li class="dropdown">
        					<?php echo anchor(base_url("homeAdm/livroAdm"),"ADMINISTRADOR",
    ...
    <section id="portfolio">
        <div class="container">
            <h2 class="text-center">PUBLICAR LIVRO</h2>
            <hr class="star-primary">
            
            <hr>
				<div class="col-lg-6 offset-lg-3">
           		<form name="enviarLivro" id="envlivro" action="../homeAdm/publicarLivro" method="POST" enctype="multipart/form-data" >
					<table>
						<tr> 
							<td><label>TÍTULO DO LIVRO : </label></td>
							<br>
							<td><input name="txtNome" type="text" size="33" maxlength="1000"></td>
						</tr>
						<tr> 
