        ...
        <div class="container">
            ...
            <hr>
				<div class="col-lg-6 offset-lg-3">
						<?php 
							echo form_open(base_url("livrosAdm/alterar")) . 
								form_hidden("idLivro",$livro[0]->idLivro) .
								form_label("Título: ","txt_titulo") .	"<br>" .							
								form_input("txt_titulo",$livro[0]->titulo) . "<br>" .
								form_label("Autor: ","txt_autor") . "<br>" .
								form_input("txt_autor", $livro[0]->autor). "<br>" .
								form_label("Descrição: ","txt_descricao") . "<br>" .
								form_textarea("txt_descricao",$livro[0]->descricao) . "<br>" .
