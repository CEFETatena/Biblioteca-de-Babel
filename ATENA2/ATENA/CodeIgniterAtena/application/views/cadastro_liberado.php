...
<body class="index" id="page-top" background="{url}assets/img/babelazul.png">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <div class="col-lg- intro-text" style="padding-top:10%">
            
                <h1><p>CADASTRO LIBERADO</p></h1>
							<p>VOCÊ JÁ PODE LOGAR NO SITE</p>	
							<?php echo anchor(base_url("welcome/entrar"),"ENTRAR", array("class" => "btn btn-mediun btn-success"));?>
